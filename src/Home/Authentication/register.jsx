...
const Register = (props) => {
  ...
  return (
    <>
      <div className={`modalRegister ${url == "" ? "d-flex" : "d-none"}`}>
        <div className="register_content">
          <h4 className="fw-bold text-center mb-4" style={{ color: "#009efb" }}>
            Siz kim bo'lib ro'yxatdan o'tmoqchisiz?
          </h4>
          <div className="row justify-content-center">
            <div className="col-lg-8">
              <div className="d-flex justify-content-center align-content-center">
                <div
                  className={`button_register text-uppercase ${url == "create-student" && "active"
                    } `}
                ...
                <div
                  className={`button_register text-uppercase ${url == "create-teacher" && "active"
                    } `}
      ...
      <div className="bg-pattern-style bg-pattern-style-register bg_blur">
        <div className="content">
          {/* Register Content */}
          <div className="account-content">
            <div className="d-flex justify-content-between align-content-center">
              <div
                className={`button_register text-uppercase disabled ${url == "create-student" && "active"
                  } `}
                onClick={() => setUrl("create-student")}
              >
                O'rganuvchi
              ...
              <div
                className={`button_register text-uppercase disabled ${url == "create-teacher" && "active" && "active"
                  } `}
                onClick={() => setUrl("create-teacher")}
              >
                Ustoz
            ...
            <div className="account-box">
              <div className="login-right">
                ...
                <form onSubmit={registerMyTeacher}>
                  ...
                  <button
                    className={`btn btn-primary login-btn ${offert == 0 ? "disabled" : ""
                      }`}
                    type="submit"
                  >
                    Ro'yxatdan o'tish
