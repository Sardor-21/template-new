              ...
              <div className="col-md-12 col-12">
                <nav aria-label="breadcrumb" className="page-breadcrumb">
                  <ol className="breadcrumb">
                    <li className="breadcrumb-item"><Link to="/index">Asosiy</Link></li>
              ...
              <div className="col-md-7 col-lg-8">
                <div className="card">
                  <div className="card-body">
                    {/* Checkout Form */}
                    <form action="/Mentee/booking-success">
                      ...
                      <div className="payment-widget">
                        ...
                        <div className="submit-section mt-4">
                          <Link to="/Mentee/booking-success" className="btn btn-primary submit-btn">Confirm and Pay</Link>
                        </div>
                        {/* /Submit Section */}
                      </div>
                    </form>
