      ...
      <div className="mt-5 pt-5">
        ...
        <div className="content">
          <div className="container">
            {/* Mentor Widget */}
            <div className="card col-12 col-md-10 mr-auto ml-auto p-0">
              <div className="card-body">
                <div className="mentor-widget justify-content-center flex-wrap row justify-content-sm-between">
                  <div className="col-12 col-sm-6 col-md-8">
                    <div className="d-flex justify-content-center flex-wrap align-items-center justify-content-md-start">
                      ...
                      <div className="user-info-cont d-flex flex-column justify-content-center justify-content-md-start  align-items-center align-items-md-start">
                        <h4 className="usr-name">Jonathan Doe</h4>
                        <p className="mentor-type social-title text-center text-sm-left">
                          English Literature (M.A)
                        </p>
                        <div className="mentor-action justify-content-center justify-content-sm-start">
                          <p className="mentor-type text-center text-sm-left  social-title">
                            Contact Me
                          </p>
                          <a href="" className="btn-blue">
                            <i className="fas fa-comments" />
                          </a>
                          <Link to="/Mentor/chat" className="btn-blue">
                  ...
                  <div className="col-12 col-sm-6 col-md-4">
                    <div className="d-flex align-items-center flex-wrap h-100 justify-content-center">
                      <div className="hireme-btn text-center">
                        ...
                        <Link className="blue-btn-radius" to="/Mentee/booking">
                          Hire Me
                        </Link>
                      </div>
                    </div>
