    ...
    return (
      <div>
                  ...
                  <div className="appointment-list">
                    ...
                    <div className="appointment-action">
                      <a
                        ...
                        onClick={() => this.setState({ isviewmodal: true })}
                        data-toggle="modal"
        ...
        <Modal
          ...
          toggle={() => this.viewModalClose()}
        >
          <ModalHeader toggle={() => this.viewModalClose()}>
            {" "}
            Appointment Details
          </ModalHeader>
          <ModalBody>
