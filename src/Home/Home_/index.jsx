...
import { homeStudentFeedbackData } from "../../Data";
...
const CausesTitle = [
  {
    ...
    text: "   Eslab qoling! Bu video ko’rib dars o’tish yoki webinarlarda qatnashib o’rganish emas. Myteacherda siz o’qituvchingiz bilan masofadan yuzma yuz ko’rishib gaplashasiz.",
  },
  {
    img: COURSES_2,
    title: "Istalgan vaqtda xohlagan joyingizdan o’qish imkoni",
    text: " Siz, biror korxinada ishlaysizmi, yoki talabamisiz, yoki uzoqda yashaysizmi farqi yoq. MyTeacher ustozlari xoh uyingiz xoh ishxona, xoh ko’chada bo’lsin, sizga dars o’tib beradilar.",
  },
  {
    img: COURSES_3,
    title: "Darajangizdan kelib chiqib individual yondashuv",
    text: " Siz Hozir qanday bilim darajada ekanligingizdan qat’iy nazar, o’rganishingiz mumkin, chunki sizning bir o’zingizga alohida bitta o’qituvchi qo’yib beriladi. Shaxsiy ustoz.",
  },
  {
    img: COURSES_4,
    title: "O'qituvchi maqul kelmasa, uni almashtirish imkoniyati",
    text: " Ayollarimizga ayol o’qituvchi tanlash imkoni bo’ladi, agar o’qituvchining dars o’tish uslubi yoki boshqa biror xususiyati sizga ma’qul kelmasa siz uni boshqasiga almashtirib olishingiz ham mumkin.",
  },
];
const Home = () => {
  const [more, setMore] = useState(false);
  const [commentMore, setCommentMore] = useState(-1);
  const [statistcs, setStatistcs] = useState([]);
  const [team, setTeam] = useState([]);
  const categories = useSelector(
    (state) => state.Reducer.home_category_list_id
  );
    ...
    <div>
      <section id="section-search" className="section section-search ">
        <div className="container">
          <div className="banner-wrapper pt-3 m-auto text-center">
            <div className="banner-header">
              <div className="mb-5">
                ...
                <span className="text-white mb-3">
                  Eng saralangan o’qituvchini shu yerdan toping va u bilan
                  individual (birga bir) o’rganing
                </span>
              </div>
      ...
      <section className="section how-it-works">
        <div className="container">
          ...
          <div className="row m-0 p-0">
            <div className="col-12 px-0 px-md-2 col-md-6 mb-3 col-lg-4">
      ...
      <section className="section popular-courses">
        <div className="container">
          ...
          <div className="row m-0 p-0">
            {top_teacher_list.length > 0 &&
              top_teacher_list.map((v, i) => {
                return (
                  <div
                    className="col-xl-6 col-12 p-0 p-md-2  card-mentors-lg"
                    key={i}
                  >
                      ...
                      <div className="card-body user_widged">
                        <div className="user_info_box">
                          <div className="info_left">
                            ...
                            >
                              <img
                                src={v.image ? baseImageUrl + v.image : USER}
                            ...
                            <div className="text info_box_rating">
                              <StarRatings
                                rating={v?.star_raytings ? v?.star_raytings : 0}
                                starDimension="17px"
                                starSpacing="0px"
                                ...
                                <div className="text">
                                  ...
                                  <div className="far fa-question-circle loyalty ps-1 text-black m-0">
                                    <div className={"loyalty_message"}>
                                      ...
                                      qanchalik olib qolishi, ya’ni umumiy kurs
                                      muddatini oxirigacha yetkazib hamma
                                      darslarni to’liq o’tishi indeksi
                                      hisoblanadi.
                                    </div>
                                  </div>
                                </div>
                        ...
                        <div className="user_description">
                          ...
                          {v?.comments?.length > 0 ? (
                            <div
                              className={
                                more == v.user_id ? "about_message" : "d-none"
                              }
                            >
                              <div className="row w-100 m-0">
                                <div className="col-6 d-flex align-items-center p-0">
                                  <img
                                    ...
                                    src={
                                      v?.comments[0].image
                                        ? baseImageUrl + v?.comments[0].image
                                        : USER
                                    }
                                    alt="user"
                                  />
                          ...
                          <div
                            ...
                            onClick={
                              !userdata && !localStorage.getItem("access_token")
                                ? () => register(v.user_id)
                                : () =>
                                    router.push(`/mentor/booking/${v.user_id}`)
                            }
                          >
                            Band qilish
                          </div>
          ...
          <div className="load-more text-center">
            <Link className="btn btn-primary btn-sm" to="/mentee/search/6">
              Yana ko'rish
            </Link>
          </div>
        </div>
      ...
      <section className="section path-section">
        ...
        <div className="container">
          <Slider {...settingSlider}>
            {homeStudentFeedbackData.map((v, i) => {
              return (
                <div className="px-3" key={i}>
                  <div
                    style={{ minHeight: "266px" }}
                    className="card px-3 card-comments-mainPage h-100"
                  >
                    <div className="p-3 px-0  h-100 px-sm-4">
                      <div className="d-flex h-100 align-items-center py-3 ">
                        <div className="avatar me-2">
                          <img
                            className="avatar-img rounded-circle"
                            alt="User Image"
                            src={v.image ? v.image : USER}
                          />
                        </div>
                        <div>
                          <h5 className="mb-0 text-primary">{v.name}</h5>
                          <p className="mb-0">{v.country}</p>
                        </div>
                      </div>

                      <div
                        className={`comment-text ${
                          commentMore == i ? "comment-long" : ""
                        }`}
                      >
                        {v.fedback}
                      </div>
                      <div
                        ...
                        onClick={() => moreInfoComment(i)}
                      >
                        {commentMore == i ? "Yopish" : "Batafsil"}{" "}
                      </div>
                    </div>
                  </div>
                </div>
      ...
      <section className="section section-blogs">
        <div className="container">
          ...
          <div className="section-header text-center">
            ...
            <p className="sub-title">
              My Teacher onlayn platformasi qanday qulayliklarni taqdim etadi va
              boshqa onlayn platformalardan nimasi bilan ajralib turadi?
            </p>
          </div>
          {/* /Section Header */}
          <div className="row m-0 p-0 blog-grid-row">
            {CausesTitle.map((v, i) => (
              <div className="col-md-6 col-lg-4 col-xl-3 my-3" key={i}>
                {/* Blog Post */}
                <div className="blog grid-blog h-100">
                  ...
                  <div className="blog-content">
                    <h3 className="blog-title  text-center">{v.title}</h3>
                    <p className="mb-0 text-center">{v.text}</p>
                  </div>
                </div>
                {/* /Blog Post */}
              </div>
      ...
      <section className="section section-team">
        <div className="container">
          ...
          <div className="section-header text-center">
            ...
            <p className="sub-title">
              Mijozlarimizga maksimum sifatli xizmat ko’rsatish maqsadida
              jamoamiz a’zolari bilan tunu kun izlanish olib bormoqdamiz. Quyida
              bizning eng faol va tashabbuskor jamo azolarimiz bilan tanishingiz
              mumkin.
            </p>
          </div>
          {/* /Section Header */}
            ...
            {team &&
              team.map((v, i) => (
                <div className="px-2 h-100" key={i}>
                  {/* Blog Post */}
                  <div className="blog h-100 grid-blog mb-0  ">
                    <div className="blog-image">
                      <img
                    ...
                    <div className="blog-content  OurTeamContent w-100">
          ...
          <div className="row">
            <div className="col-12 col-md-4">
              <div className="statistics-list text-center">
                ...
                <span>750+</span>
                <h3 className="text-white"> O'tilgan darslar soni</h3>
              </div>
            </div>
            <div className="col-12 col-md-4">
              <div className="statistics-list text-center">
                ...
                <span>150</span>
                <h3 className="text-white">O'quvchilar soni</h3>
              </div>
            </div>
            <div className="col-12 col-md-4">
              <div className="statistics-list text-center">
                <span>{statistcs.teacher_count}</span>
                <h3 className="text-white">O'qituvchilar soni</h3>
              </div>
            </div>
          </div>
        </div>
