...
const Team = () => {
  ...
  const edit = (id) => {
    ...
    setImagePreview(`${baseImageUrl}${clone.image}`);
    setEditId(id);
    setModal(true);
  };
  ...
  useEffect(() => {
    let active = true;
    if (active) get_team(setTeam, setModal);
    return () => {
      active = false;
    };
  }, []);
              ...
              >
                <div className="card h-100">
                  ...
                  <div className="d-flex flex-wrap justify-content-center align-items-center w-100 py-2">
                    ...
                    <button
                      onClick={() => delete_team(v.id, setModal, setTeam)}
        ...
        <ModalBody>
          ...
          <form>
            <div className="row">
              ...
              <div className="col-md-6">
                <FormGroup label={"Kasbi"} value={job} setValue={setJob} />
              </div>
              <div className="col-12">
                <div className="form-group">
