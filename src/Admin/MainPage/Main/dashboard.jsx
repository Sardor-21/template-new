...
import { USER, AVATAR_01 } from "../../imagepath";
...
const AdminDashboard = () => {
  ...
  const data = useSelector((state) => state.Admin.admin_data);
  const dashboard = useSelector((state) => state.Admin.admin_dashboard);
                  ...
                  <div className="card-body">
                    <div className="dash-widget-header">
                      ...
                      <div className="dash-count">
                        <h3>{dashboard?.lead_count}</h3>
                      </div>
                    </div>
                    <div className="dash-widget-info">
                      <h6 className="text-muted">Leadlar soni</h6>
                ...
                <div className="card">
                  <div className="card-body">
                    <div className="dash-widget-header">
                      ...
                      <div className="dash-count">
                        <h3>
                          {dashboard?.allowed_test_lessons_count}/
                          {dashboard?.test_lessons_count}
                        </h3>
                      </div>
                    </div>
                    <div className="dash-widget-info">
