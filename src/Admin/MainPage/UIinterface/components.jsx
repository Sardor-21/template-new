...
import {  AVATAR_01, IMG_01 } from "../../imagepath"
              ...
              <div className="row">
                  ...
                  <div className="card">
                    ...
                    <div className="card-body">
                      <div className="avatar avatar-xxl">
                        <img className="avatar-img rounded-circle" alt="User Image" src={AVATAR_01} />
                      </div>
                ...
                <div className="col-md-12">
                  <div className="card">
                    ...
                    <div className="card-body">
                      <div className="avatar">
                        <img className="avatar-img rounded" alt="User Image" src={AVATAR_01} />
                      </div>
                      <div className="avatar">
                        <img className="avatar-img rounded-circle" alt="User Image" src={AVATAR_01} />
                      </div>
